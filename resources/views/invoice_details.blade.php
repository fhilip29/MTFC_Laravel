    ...
    <div class="bg-[#1F2937] shadow-lg rounded-xl p-3 sm:p-5 border border-[#374151]">
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex items-center gap-2">
                <a href="{{ route('profile') }}" class="text-[#9CA3AF] hover:text-white transition-colors">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <h1 class="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                    <i class="fas fa-file-invoice text-[#9CA3AF]"></i> Receipt #{{ $invoice->invoice_number }}
                </h1>
            </div>
            <div class="flex gap-2">
                <button onclick="window.print()" class="bg-[#374151] hover:bg-[#4B5563] text-white font-medium flex items-center gap-1 px-3 py-1.5 rounded-md shadow transition-colors text-sm">
            ...
            <div class="w-full md:w-1/3 space-y-3">
                ...
                <div class="bg-[#374151] p-3 rounded-lg">
                    <div class="flex justify-between items-center border-b border-[#4B5563] pb-2 mb-2">
                        <h2 class="text-[#9CA3AF] text-xs font-semibold uppercase">Receipt Info</h2>
                    ...
                    <div class="space-y-1.5 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-white">{{ $invoice->payment_method ?? 'Cash' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-[#374151] p-3 rounded-lg">
                    <div class="border-b border-[#4B5563] pb-2 mb-2">
                        <h2 class="text-[#9CA3AF] text-xs font-semibold uppercase">Your Information</h2>
                    </div>
                    <div class="space-y-1.5 text-sm">
