...
<section class="bg-gray-100">
  <div class="w-full mx-auto">
    ...
    <div class="relative text-white text-center">
      ...
      <div class="absolute inset-0 flex flex-col justify-center items-start bg-black bg-opacity-50 p-4 px-36">
    ...
    <!-- About Us & Community -->
    <div class="flex px-36 py-12 gap-12">
      <div class="w-2/3 space-y-10 text-justify">
        <!-- About Us -->
        <div>
      ...
      <div class="flex-1 mt-28">
        <img src="{{ asset('assets/about2.jpg') }}" alt="Gym" class="w-full h-auto">
      </div>
    </div>

    <!-- Map Section -->
    <div class="flex px-36 py-12 mt-14 bg-[#D9D9D9] gap-12">
      <div class="flex-1">
        <!-- Google Map Embed -->
