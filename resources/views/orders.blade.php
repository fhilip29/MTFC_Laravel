        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">67fb354008620e3004a8000</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2025-04-13</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-200 text-gray-800">Pending</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <button @click="showModal = true; selectedOrder = { id: '67fb354008620e3004a8000', date: '2025-04-13', status: 'Pending', progress: 25, items: [{ name: 'All Max Classic All Whey', image: '/assets/Product2_MTFC.jpg', qty: 1, price: 3000 }], total: 3000, address: '123 Main St, City, Country' }" class="text-blue-600 hover:text-blue-900 focus:outline-none transition duration-150 ease-in-out">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">67f1e208cc16bbe38bce1cb</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2025-04-06</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Cancelled</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <button @click="showModal = true; selectedOrder = { id: '67f1e208cc16bbe38bce1cb', date: '2025-04-06', status: 'Cancelled', progress: 0, items: [{ name: 'All Max Classic All Whey', image: '/assets/Product2_MTFC.jpg', qty: 2, price: 6000 }], total: 6000, address: '456 Oak St, City, Country' }" class="text-blue-600 hover:text-blue-900 focus:outline-none transition duration-150 ease-in-out">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">67f0ec29da9e8fa68e4f90f8</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2025-04-05</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Completed</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <button @click="showModal = true; selectedOrder = { id: '67f0ec29da9e8fa68e4f90f8', date: '2025-04-05', status: 'Completed', progress: 100, items: [{ name: 'All Max Classic All Whey', image: '/assets/Product2_MTFC.jpg', qty: 3, price: 9000 }], total: 9000, address: '789 Pine St, City, Country' }" class="text-blue-600 hover:text-blue-900 focus:outline-none transition duration-150 ease-in-out">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    ...
                                    <div class="flex mb-2 items-center justify-between">
                                        <div>
                                            <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full" :class="{
                                                'text-green-600 bg-green-200': selectedOrder?.status === 'Completed',
                                                'text-gray-600 bg-gray-200': selectedOrder?.status === 'Pending',
                                                'text-red-600 bg-red-200': selectedOrder?.status === 'Cancelled'
                            ...
                            <div class="mt-4 pt-4 border-t">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold" x-text="'₱' + selectedOrder?.total"></span>
                                </div>
