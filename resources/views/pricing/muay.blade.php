    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        <div class="flex flex-wrap justify-center gap-8">
            ...
            <div class="w-80 bg-white rounded-2xl shadow-lg p-6 flex flex-col border-2 border-blue-600">
                ...
                <div class="flex justify-between items-center mt-auto">
                    ...
                    @if(Auth::check())
                        ...
                        @else
                            <button onclick="openWaiverModal('muay', 'monthly', '3200.00')" class="text-sm px-3 py-1 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">
                                Join Now
                            </button>
                        @endif
                    @else
            ...
            <div class="w-80 bg-white rounded-2xl shadow-lg p-6 flex flex-col">
                ...
                <div class="flex justify-between items-center mt-auto">
                    <span class="text-lg font-semibold text-gray-800">₱2,600 / session</span>
                    @if(Auth::check())
                        @if($userHasActive)
                            <span class="text-sm px-3 py-1 bg-gray-100 text-gray-600 rounded-full">Active</span>
                        @elseif($userRole === 'admin')
