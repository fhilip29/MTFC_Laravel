...
@section('title', 'Trainer Attendance History')
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('trainer.profile') }}" class="inline-flex items-center bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors">
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-6 border border-gray-200">
            ...
            <form action="{{ route('trainer.attendance') }}" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <!-- Month Select -->
                <div>
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('trainer.attendance') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 flex-1 text-center">
            ...
            <div class="bg-white rounded-lg shadow p-4 border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <h4 class="text-sm font-medium text-gray-900">Setting an Example</h4>
                            <p class="text-sm text-gray-500">
                                As a trainer, your consistent attendance helps motivate members. Your commitment reflects your professionalism.
                            </p>
                        </div>
                    </div>
                </div>
