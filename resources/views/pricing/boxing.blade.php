...
<section class="relative w-full min-h-[calc(100vh-5rem)] text-gray-800">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-16 pb-24">
        <!-- Title -->
        <h1 class="text-3xl md:text-5xl font-bold text-white text-center mb-10">Boxing Pricing</h1>
        ...
        <div class="flex justify-center space-x-4 mb-10 overflow-x-auto">
            ...
            <a href="{{ route('pricing.boxing') }}" class="px-5 py-2 rounded-md text-white font-semibold bg-gray-300 text-black">
                Boxing
            </a>
        ...
        <div class="flex flex-wrap justify-center gap-8">
            ...
            <div class="w-80 bg-white rounded-2xl shadow-lg p-6">
                ...
                <ul class="text-sm text-gray-700 space-y-2 mb-6">
                    <li class="flex items-start gap-2">
                        <x-check-icon /> Access to boxing rings and equipment
                    </li>
                    <li class="flex items-start gap-2">
                        <x-check-icon /> Guidance from certified boxing trainers
                    </li>
                    <li class="flex items-start gap-2">
            ...
            <div class="w-80 bg-white rounded-2xl shadow-lg p-6">
                ...
                <ul class="text-sm text-gray-700 space-y-2 mb-6">
                    <li class="flex items-start gap-2"><x-check-icon /> Access to boxing rings and equipment</li>
                    <li class="flex items-start gap-2"><x-check-icon /> Personalized training plan</li>
                    <li class="flex items-start gap-2"><x-check-icon /> Use of locker room facilities</li>
                    <li class="flex items-start gap-2"><x-check-icon /> Complimentary boxing gloves and wraps</li>
                </ul>
                <div class="flex justify-between items-center mt-auto">
                    <span class="text-lg font-semibold text-gray-800">₱2000 / month</span>
                    <button onclick="openWaiverModal()" class="text-sm px-3 py-1 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">Join Now</button>
                </div>
            </div>
        </div>
    </div>
