    ...
    <div class="max-w-full mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm">
                ...
                <li><a href="/contact" class="text-black relative transform hover:scale-110 transition-transform duration-300 after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-red-500 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 hover:text-red-500">Contact Us</a></li>
                <li><a href="/trainers" class="text-black relative transform hover:scale-110 transition-transform duration-300 after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-red-500 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 hover:text-red-500">Trainers</a></li>
