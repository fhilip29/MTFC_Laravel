...
<div class="page-transition">
    ...
    <section class="relative w-full min-h-screen text-gray-800">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 py-8 sm:py-16">
            <!-- Title -->
            <h1 class="text-2xl sm:text-3xl md:text-5xl font-bold text-white text-center mb-4 sm:mb-6">Muay Thai Membership Plans</h1>
            <p class="text-base sm:text-lg text-white text-center mb-6 sm:mb-10">Train in the art of eight limbs with experienced Muay Thai instructors</p>
            ...
            <div class="flex justify-center mb-10 w-full overflow-x-auto pb-2 px-2 snap-x scrollbar-hide">
                <div class="flex space-x-2 md:space-x-4 min-w-max mx-auto">
                    ...
                    <a href="{{ route('pricing.muay') }}" class="px-4 py-2 rounded-md font-semibold bg-gray-300 text-black whitespace-nowrap snap-start">
                        Muay Thai
                    </a>
